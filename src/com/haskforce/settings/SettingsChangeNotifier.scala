...
object SettingsChangeNotifier {
  trait GhcModiSettingsChangeNotifier extends SettingsChangeNotifier[GhcModiToolSettings]
  val GHC_MODI_TOPIC: Topic[GhcModiSettingsChangeNotifier] =
    Topic.create("ghc-modi", classOf[GhcModiSettingsChangeNotifier])

  trait HsDevSettingsChangeNotifier extends SettingsChangeNotifier[HsDevToolSettings]
