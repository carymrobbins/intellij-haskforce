...
public class ExportSpecTopTypeDeserializer implements JsonDeserializer<ExportSpecTopType> {
    ...
    public ExportSpecTopType deserialize(JsonElement jsonElement, Type type,
        ...
        if ((stuff = objType.getAsJsonArray("EVar")) != null) { // TODO: Test.
            EVar eVar = new EVar();
            ...
            return eVar;
        } else if ((stuff = objType.getAsJsonArray("EAbs")) != null) { // TODO: Test.
            EAbs eAbs = new EAbs();
            ...
            return eAbs;
        } else if ((stuff = objType.getAsJsonArray("EThingAll")) != null) { // TODO: Test.
            ...
            return eThingAll;
        } else if ((stuff = objType.getAsJsonArray("EThingWith")) != null) { // TODO: Test.
            ...
            return eThingWith;
        } else if ((stuff = objType.getAsJsonArray("EModuleContents")) != null) { // TODO: Test.
