...
public class CabalFrameworksImpl extends CabalCompositeElementImpl implements CabalFrameworks {

  public CabalFrameworksImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitFrameworks(this);
