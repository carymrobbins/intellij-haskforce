...
public class CabalAuthorImpl extends CabalCompositeElementImpl implements CabalAuthor {

  public CabalAuthorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitAuthor(this);
