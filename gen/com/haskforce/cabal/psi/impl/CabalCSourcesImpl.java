...
public class CabalCSourcesImpl extends CabalCompositeElementImpl implements CabalCSources {

  public CabalCSourcesImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitCSources(this);
