...
public class CabalJsSourcesImpl extends CabalCompositeElementImpl implements CabalJsSources {

  public CabalJsSourcesImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitJsSources(this);
