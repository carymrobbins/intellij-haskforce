...
public class CabalBenchmarkKeysImpl extends CabalCompositeElementImpl implements CabalBenchmarkKeys {

  public CabalBenchmarkKeysImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitBenchmarkKeys(this);
