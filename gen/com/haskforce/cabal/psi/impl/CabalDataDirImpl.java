...
public class CabalDataDirImpl extends CabalCompositeElementImpl implements CabalDataDir {

  public CabalDataDirImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitDataDir(this);
