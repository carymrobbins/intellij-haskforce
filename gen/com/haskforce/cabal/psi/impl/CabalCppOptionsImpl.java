...
public class CabalCppOptionsImpl extends CabalCompositeElementImpl implements CabalCppOptions {

  public CabalCppOptionsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitCppOptions(this);
