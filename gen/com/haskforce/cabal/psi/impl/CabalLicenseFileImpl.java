...
public class CabalLicenseFileImpl extends CabalCompositeElementImpl implements CabalLicenseFile {

  public CabalLicenseFileImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitLicenseFile(this);
