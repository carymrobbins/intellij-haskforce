...
public class CabalBoolImpl extends CabalCompositeElementImpl implements CabalBool {

  public CabalBoolImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitBool(this);
