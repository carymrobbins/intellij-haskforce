...
public class CabalHsSourceDirsImpl extends CabalCompositeElementImpl implements CabalHsSourceDirs {

  public CabalHsSourceDirsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitHsSourceDirs(this);
