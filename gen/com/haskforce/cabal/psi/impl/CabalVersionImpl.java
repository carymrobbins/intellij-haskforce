...
public class CabalVersionImpl extends CabalCompositeElementImpl implements CabalVersion {

  public CabalVersionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitVersion(this);
