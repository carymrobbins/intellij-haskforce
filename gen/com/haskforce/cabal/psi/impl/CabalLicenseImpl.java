...
public class CabalLicenseImpl extends CabalCompositeElementImpl implements CabalLicense {

  public CabalLicenseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitLicense(this);
