...
public class CabalDirectoryImpl extends CabalCompositeElementImpl implements CabalDirectory {

  public CabalDirectoryImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitDirectory(this);
