...
public class CabalProjectNameImpl extends CabalCompositeElementImpl implements CabalProjectName {

  public CabalProjectNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitProjectName(this);
