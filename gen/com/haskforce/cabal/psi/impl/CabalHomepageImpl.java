...
public class CabalHomepageImpl extends CabalCompositeElementImpl implements CabalHomepage {

  public CabalHomepageImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitHomepage(this);
