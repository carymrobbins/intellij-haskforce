...
public class CabalExecutableKeysImpl extends CabalCompositeElementImpl implements CabalExecutableKeys {

  public CabalExecutableKeysImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitExecutableKeys(this);
