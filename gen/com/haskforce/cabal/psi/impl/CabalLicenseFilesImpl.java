...
public class CabalLicenseFilesImpl extends CabalCompositeElementImpl implements CabalLicenseFiles {

  public CabalLicenseFilesImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitLicenseFiles(this);
