...
public class CabalIncludesImpl extends CabalCompositeElementImpl implements CabalIncludes {

  public CabalIncludesImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitIncludes(this);
