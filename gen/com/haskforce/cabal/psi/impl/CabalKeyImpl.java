...
public class CabalKeyImpl extends CabalCompositeElementImpl implements CabalKey {
  ...
  @Override
  @Nullable
  public CabalComplexkey getComplexkey() {
    return findChildByClass(CabalComplexkey.class);
  }

  @Override
  @Nullable
  public CabalSimplekey getSimplekey() {
    return findChildByClass(CabalSimplekey.class);
  }
