...
public class CabalSynopsisImpl extends CabalCompositeElementImpl implements CabalSynopsis {

  public CabalSynopsisImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitSynopsis(this);
