...
public class CabalCcOptionsImpl extends CabalCompositeElementImpl implements CabalCcOptions {

  public CabalCcOptionsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitCcOptions(this);
