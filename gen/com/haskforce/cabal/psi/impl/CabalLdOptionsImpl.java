...
public class CabalLdOptionsImpl extends CabalCompositeElementImpl implements CabalLdOptions {

  public CabalLdOptionsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitLdOptions(this);
