...
public class CabalExtraLibDirsImpl extends CabalCompositeElementImpl implements CabalExtraLibDirs {

  public CabalExtraLibDirsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitExtraLibDirs(this);
