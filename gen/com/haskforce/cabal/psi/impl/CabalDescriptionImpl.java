...
public class CabalDescriptionImpl extends CabalCompositeElementImpl implements CabalDescription {

  public CabalDescriptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitDescription(this);
