...
public class CabalOtherModulesImpl extends CabalCompositeElementImpl implements CabalOtherModules {

  public CabalOtherModulesImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitOtherModules(this);
