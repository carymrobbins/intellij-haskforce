...
public class CabalStabilityImpl extends CabalCompositeElementImpl implements CabalStability {

  public CabalStabilityImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitStability(this);
