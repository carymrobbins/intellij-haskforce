...
public class CabalDataFilesImpl extends CabalCompositeElementImpl implements CabalDataFiles {

  public CabalDataFilesImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitDataFiles(this);
