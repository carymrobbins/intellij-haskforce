...
public class CabalGhcOptionsImpl extends CabalCompositeElementImpl implements CabalGhcOptions {

  public CabalGhcOptionsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitGhcOptions(this);
