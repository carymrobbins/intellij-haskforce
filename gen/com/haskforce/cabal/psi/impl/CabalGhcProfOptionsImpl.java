...
public class CabalGhcProfOptionsImpl extends CabalCompositeElementImpl implements CabalGhcProfOptions {

  public CabalGhcProfOptionsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CabalVisitor) ((CabalVisitor)visitor).visitGhcProfOptions(this);
