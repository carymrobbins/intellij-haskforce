...
public class HaskellStmtImpl extends ASTWrapperPsiElement implements HaskellStmt {

  public HaskellStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HaskellVisitor) ((HaskellVisitor)visitor).visitStmt(this);
