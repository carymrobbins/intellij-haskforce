...
public class HaskellReservedopWithoutConsImpl extends ASTWrapperPsiElement implements HaskellReservedopWithoutCons {

  public HaskellReservedopWithoutConsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HaskellVisitor) ((HaskellVisitor)visitor).visitReservedopWithoutCons(this);
