...
public class HaskellParser implements PsiParser {
  ...
  private static boolean aexp_6(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = aexp_6_0(builder_, level_ + 1);
  ...
  // '[|' | '[' exp '|' [semi]
  private static boolean aexp_6_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "aexp_6_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LTHOPEN);
    if (!result_) result_ = aexp_6_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // '[' exp '|' [semi]
  private static boolean aexp_6_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "aexp_6_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LBRACKET);
    result_ = result_ && exp(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, PIPE);
    result_ = result_ && aexp_6_0_1_3(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [semi]
  private static boolean aexp_6_0_1_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "aexp_6_0_1_3")) return false;
  ...
  private static boolean aexp_7_1(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = aexp_7_1_1(builder_, level_ + 1);
    if (!result_) result_ = aexp_7_1_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // "p" '|' infixexp
  private static boolean aexp_7_1_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "aexp_7_1_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  private static boolean aexp_7_1_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "aexp_7_1_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
