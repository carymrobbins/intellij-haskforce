...
public class HaskellParser implements PsiParser {
  ...
  static boolean aexp(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = consumeToken(builder_, IDSPLICE);
    if (!result_) result_ = aexp_3(builder_, level_ + 1);
    if (!result_) result_ = literal(builder_, level_ + 1);
    if (!result_) result_ = thaexp(builder_, level_ + 1);
  ...
  private static boolean aexp_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, PARENSPLICE);
  ...
  private static boolean aexp_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && i(builder_, level_ + 1);
    result_ = result_ && aexp_1_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // qvar | qcon
  private static boolean aexp_1_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "aexp_1_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  // (fbind ',')*
  private static boolean aexp_9_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "aexp_9_3")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!aexp_9_3_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "aexp_9_3", pos_)) break;
  ...
  // fbind ','
  private static boolean aexp_9_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "aexp_9_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  public static boolean alt(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && i(builder_, level_ + 1);
    result_ = result_ && alt_2(builder_, level_ + 1);
    pinned_ = result_; // pin = 3
    result_ = result_ && alt_3(builder_, level_ + 1);
  ...
  private static boolean alt_2(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = alt_2_0(builder_, level_ + 1);
  ...
  // '->' exp
  private static boolean alt_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "alt_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  // [wheredecls]
  private static boolean alt_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "alt_3")) return false;
  ...
  public static boolean body(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && report_error_(builder_, bodyaux(builder_, level_ + 1));
  ...
  private static boolean bodyaux_0(PsiBuilder builder_, int level_) {
    ...
    int pos_ = current_position_(builder_);
    while (true) {
      if (!impdecls(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "bodyaux_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // var | con
  static boolean cname(PsiBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // <<sequence cname>>
  static boolean cnames(PsiBuilder builder_, int level_) {
    return sequence(builder_, level_ + 1, cname_parser_);
  }
  ...
  private static boolean constr_1_1_0_1(PsiBuilder builder_, int level_) {
    ...
    constr_1_1_0_1_0(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean constr_1_1_0_1_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = constr_1_1_0_1_0_0(builder_, level_ + 1);
  ...
  // (fielddecl ',')*
  private static boolean constr_1_1_0_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "constr_1_1_0_1_0_0")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!constr_1_1_0_1_0_0_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "constr_1_1_0_1_0_0", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // fielddecl ','
  private static boolean constr_1_1_0_1_0_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "constr_1_1_0_1_0_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  static boolean dclass(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dclass")) return false;
    if (!nextTokenIs(builder_, CONIDREGEXP)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = qtycls(builder_, level_ + 1);
    result_ = result_ && dclass_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // (dclass|tyvar)*
  private static boolean dclass_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dclass_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!dclass_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "dclass_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // dclass|tyvar
  private static boolean dclass_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "dclass_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  /* ********************************************************** */
  // <<indented true>>
  static boolean e(PsiBuilder builder_, int level_) {
    return indented(builder_, level_ + 1, true);
  }
  ...
  private static boolean export_1_1_0(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, LPAREN);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, export_1_1_0_1(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, RPAREN) && result_;
    exit_section_(builder_, level_, marker_, null, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  // ".." | cnames | qvars
  private static boolean export_1_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "export_1_1_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, DOUBLEPERIOD);
  ...
  // fatype ["->" ftype]
  //                 | "()"
  static boolean ftype(PsiBuilder builder_, int level_) {
  ...
  private static boolean gendecl_1(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && gendecl_1_2(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, null, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  // <<sequence op>>
  private static boolean gendecl_1_2(PsiBuilder builder_, int level_) {
    return sequence(builder_, level_ + 1, op_parser_);
  }
  ...
  static boolean i(PsiBuilder builder_, int level_) {
    return indented(builder_, level_ + 1, false);
  }
  ...
  static boolean iAlts(PsiBuilder builder_, int level_) {
    ...
    result_ = open(builder_, level_ + 1);
    result_ = result_ && alt(builder_, level_ + 1);
    result_ = result_ && iAlts_2(builder_, level_ + 1);
  ...
  // (semi alt)*
  private static boolean iAlts_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "iAlts_2")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!iAlts_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "iAlts_2", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // semi alt
  private static boolean iAlts_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "iAlts_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = semi(builder_, level_ + 1);
    result_ = result_ && alt(builder_, level_ + 1);
  ...
  public static boolean impdecl(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && impdecl_4(builder_, level_ + 1) && result_;
  ...
  private static boolean importt_1_1_0(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LPAREN);
    result_ = result_ && importt_1_1_0_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RPAREN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean impspec_0_0(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, HIDING);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean lexp_1(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, consumeToken(builder_, RIGHTARROW));
  ...
  private static boolean lexp_1_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = lexp_1_1_0(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!lexp_1_1_0(builder_, level_ + 1)) break;
  ...
  // apat | thaexp
  private static boolean lexp_1_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "lexp_1_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = apat(builder_, level_ + 1);
    if (!result_) result_ = thaexp(builder_, level_ + 1);
  ...
  private static boolean lexp_2(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && decls(builder_, level_ + 1);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, consumeToken(builder_, IN));
    result_ = pinned_ && exp(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, null, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  private static boolean lexp_4(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && exp(builder_, level_ + 1);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, consumeToken(builder_, OF));
  ...
  private static boolean lexp_5(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && open(builder_, level_ + 1);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, stmts(builder_, level_ + 1));
    result_ = pinned_ && close(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, null, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  private static boolean lexp_8(PsiBuilder builder_, int level_) {
    ...
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!aexp(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "lexp_8", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  private static boolean parenlike1_0_1(PsiBuilder builder_, int level_) {
    ...
    int pos_ = current_position_(builder_);
    while (true) {
      if (!parenlike1_0_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "parenlike1_0_1", pos_)) break;
      pos_ = current_position_(builder_);
    }
    return true;
  }
  ...
  // ',' exp
  private static boolean parenlike1_0_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parenlike1_0_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && exp(builder_, level_ + 1);
  ...
  private static boolean parenlike1_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = parenlike1_1_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RPAREN);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // infixexp qop | qop infixexp
  private static boolean parenlike1_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parenlike1_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = parenlike1_1_0_0(builder_, level_ + 1);
    if (!result_) result_ = parenlike1_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // infixexp qop
  private static boolean parenlike1_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parenlike1_1_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  // qop infixexp
  private static boolean parenlike1_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "parenlike1_1_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = qop(builder_, level_ + 1);
    result_ = result_ && infixexp(builder_, level_ + 1);
  ...
  // [pat '<-']
  private static boolean stmt_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "stmt_1_0")) return false;
    stmt_1_0_0(builder_, level_ + 1);
    return true;
  }

  // pat '<-'
  private static boolean stmt_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "stmt_1_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = pat(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, LEFTARROW);
  ...
  static boolean thaexp(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "", LTHOPEN, QQOPEN)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = thaexp_0(builder_, level_ + 1);
    if (!result_) result_ = thaexp_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // '[|' e (exp [semi])+ e '|]'
  private static boolean thaexp_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "thaexp_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LTHOPEN);
    result_ = result_ && e(builder_, level_ + 1);
    result_ = result_ && thaexp_0_2(builder_, level_ + 1);
    result_ = result_ && e(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RTHCLOSE);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // (exp [semi])+
  private static boolean thaexp_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "thaexp_0_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = thaexp_0_2_0(builder_, level_ + 1);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!thaexp_0_2_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "thaexp_0_2", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  // exp [semi]
  private static boolean thaexp_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "thaexp_0_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = exp(builder_, level_ + 1);
    result_ = result_ && thaexp_0_2_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // [semi]
  private static boolean thaexp_0_2_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "thaexp_0_2_0_1")) return false;
    semi(builder_, level_ + 1);
    return true;
  }

  // qqopen i qvarid i '|' qqtext+ '|]'
  private static boolean thaexp_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "thaexp_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, QQOPEN);
    result_ = result_ && i(builder_, level_ + 1);
    result_ = result_ && qvarid(builder_, level_ + 1);
    result_ = result_ && i(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, PIPE);
    result_ = result_ && thaexp_1_5(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RTHCLOSE);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // qqtext+
  private static boolean thaexp_1_5(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "thaexp_1_5")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, QQTEXT);
    int pos_ = current_position_(builder_);
    while (result_) {
      if (!consumeToken(builder_, QQTEXT)) break;
      if (!empty_element_parsed_guard_(builder_, "thaexp_1_5", pos_)) break;
      pos_ = current_position_(builder_);
    }
    exit_section_(builder_, marker_, null, result_);
    return result_;
  ...
  static boolean topdecl1(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = impdecl(builder_, level_ + 1);
    if (!result_) result_ = infixexp(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
