...
public class HaskellParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // aexp aexp*
  static boolean aexps(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "aexps")) return false;
    boolean r, p;
  ...
  // aexp*
  private static boolean aexps_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "aexps_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!aexp(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "aexps_1", c)) break;
    }
    return true;
  }
  ...
  public static boolean akind(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, AKIND, "<akind>");
  ...
  private static boolean apat_3_1(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = parseTokens(b, 0, PLUS, INTEGERTOKEN);
  ...
  public static boolean atype(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _COLLAPSE_, ATYPE, "<atype>");
    r = atype_0(b, l + 1);
    r = r && atype_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  private static boolean atype_1(PsiBuilder b, int l) {
    ...
    r = atype_1_0(b, l + 1);
    if (!r) r = tyvar(b, l + 1);
    if (!r) r = atype_1_2(b, l + 1);
    if (!r) r = atype_1_3(b, l + 1);
    if (!r) r = atype_1_4(b, l + 1);
    if (!r) r = atype_1_5(b, l + 1);
  ...
  // [singlequote] ntgtycon ['##'|'#']
  private static boolean atype_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = atype_1_0_0(b, l + 1);
    r = r && ntgtycon(b, l + 1);
    r = r && atype_1_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // [singlequote]
  private static boolean atype_1_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_0_0")) return false;
    consumeToken(b, SINGLEQUOTE);
    return true;
  }

  // ['##'|'#']
  private static boolean atype_1_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_0_2")) return false;
    atype_1_0_2_0(b, l + 1);
    return true;
  }

  // '##'|'#'
  private static boolean atype_1_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_0_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // '(' ['?'] ctype "::" (kind | ctype)')'
  private static boolean atype_1_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_4")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, LPAREN);
    r = r && atype_1_4_1(b, l + 1);
    r = r && ctype(b, l + 1);
    r = r && consumeToken(b, DOUBLECOLON);
    r = r && atype_1_4_4(b, l + 1);
    r = r && consumeToken(b, RPAREN);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // ['?']
  private static boolean atype_1_4_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_4_1")) return false;
    consumeToken(b, QUESTION);
    return true;
  }

  // kind | ctype
  private static boolean atype_1_4_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_4_4")) return false;
    boolean r;
    r = kind(b, l + 1);
    if (!r) r = ctype(b, l + 1);
    return r;
  ...
  private static boolean atype_1_5_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_5_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = atype_1_5_1_0(b, l + 1);
    if (!r) r = atype_1_5_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // '(' [<<sequence ctype>>] ')'
  private static boolean atype_1_5_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_5_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, LPAREN);
    r = r && atype_1_5_1_0_1(b, l + 1);
    r = r && consumeToken(b, RPAREN);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // [<<sequence ctype>>]
  private static boolean atype_1_5_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_5_1_0_1")) return false;
    sequence(b, l + 1, ctype_parser_);
    return true;
  }

  // '[' <<sequence ctype>> ']'
  private static boolean atype_1_5_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "atype_1_5_1_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, LBRACKET);
    r = r && sequence(b, l + 1, ctype_parser_);
  ...
  public static boolean bkind(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, BKIND, "<bkind>");
    r = akind(b, l + 1);
    r = r && bkind_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  public static boolean body(PsiBuilder b, int l) {
    ...
    r = r && open(b, l + 1);
    p = r; // pin = 2
    r = r && report_error_(b, body_2(b, l + 1));
    r = p && close(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  static boolean caseof(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "caseof")) return false;
  ...
  public static boolean classdecl(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, CLASSDECL, null);
  ...
  public static boolean clscontext(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CLSCONTEXT, "<clscontext>");
    r = btype(b, l + 1);
  ...
  // (',' <<p>>)*
  private static boolean commaSeparate_2(PsiBuilder b, int l, Parser _p) {
  ...
  // ',' <<p>>
  private static boolean commaSeparate_2_0(PsiBuilder b, int l, Parser _p) {
  ...
  /* ********************************************************** */
  // '(' <<p>> (',' (<<p>> | &')'))* ')'
  static boolean commaSeparate2(PsiBuilder b, int l, Parser _p) {
  ...
  // (',' (<<p>> | &')'))*
  private static boolean commaSeparate2_2(PsiBuilder b, int l, Parser _p) {
  ...
  // ',' (<<p>> | &')')
  private static boolean commaSeparate2_2_0(PsiBuilder b, int l, Parser _p) {
  ...
  // <<p>> | &')'
  private static boolean commaSeparate2_2_0_1(PsiBuilder b, int l, Parser _p) {
  ...
  public static boolean con(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<con>", CONIDREGEXP, LPAREN)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CON, "<con>");
    r = conid(b, l + 1);
    if (!r) r = con_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  public static boolean conop(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CONOP, "<conop>");
    r = consym(b, l + 1);
  ...
  public static boolean constr(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CONSTR, "<constr>");
    r = constr_0(b, l + 1);
  ...
  public static boolean datadecl(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, DATADECL, null);
    r = consumeToken(b, DATA);
    p = r; // pin = 1
  ...
  /* ********************************************************** */
  // ppragma* decl ppragma*
  static boolean decls0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "decls0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = decls0_0(b, l + 1);
    r = r && decl(b, l + 1);
  ...
  // ppragma*
  private static boolean decls0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "decls0_0")) return false;
    while (true) {
      int c = current_position_(b);
      if (!ppragma(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "decls0_0", c)) break;
    }
    return true;
  }

  // ppragma*
  private static boolean decls0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "decls0_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!ppragma(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "decls0_2", c)) break;
    }
    return true;
  }
  ...
  // (semi decls0)*
  private static boolean decls1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "decls1_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!decls1_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "decls1_1", c)) break;
    }
    return true;
  }

  // semi decls0
  private static boolean decls1_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "decls1_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = semi(b, l + 1);
    r = r && decls0(b, l + 1);
  ...
  public static boolean defaultdecl(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, DEFAULTDECL, null);
  ...
  /* ********************************************************** */
  // "do" stmts
  static boolean doblock(PsiBuilder b, int l) {
  ...
  static boolean e(PsiBuilder b, int l) {
    return indented(b, l + 1, TRUE_parser_);
  }
  ...
  public static boolean exportsempty(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, EXPORTSEMPTY, "<exportsempty>");
    r = consumeToken(b, "()");
  ...
  public static boolean fixity(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, FIXITY, "<fixity>");
  ...
  public static boolean foreigndecl(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, FOREIGNDECL, null);
  ...
  public static boolean funorpatdecl(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, FUNORPATDECL, "<funorpatdecl>");
  ...
  private static boolean gadtconstr_1(PsiBuilder b, int l) {
    ...
    r = r && consumeToken(b, LBRACE);
    r = r && fielddecls(b, l + 1);
    r = r && consumeTokens(b, 0, RBRACE, DOUBLECOLON);
    r = r && ctype(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  static boolean gcon(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = parseTokens(b, 0, LBRACKET, RBRACKET);
    if (!r) r = gcon_1(b, l + 1);
    if (!r) r = qcon(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  ...
  public static boolean gconsym(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, GCONSYM, "<gconsym>");
  ...
  public static boolean gendecl(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, GENDECL, "<gendecl>");
    r = gendeclfst(b, l + 1);
  ...
  static boolean i(PsiBuilder b, int l) {
    return indented(b, l + 1, FALSE_parser_);
  }
  ...
  public static boolean idecl(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, IDECL, "<idecl>");
    r = itdecl(b, l + 1);
  ...
  static boolean ifexpr(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, ifexpr_5(b, l + 1)) && r;
  ...
  public static boolean impempty(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, IMPEMPTY, "<impempty>");
    r = consumeToken(b, "()");
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean importt(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, IMPORTT, "<importt>");
    r = var(b, l + 1);
  ...
  /* ********************************************************** */
  // '(' [<<sequence [importt]>>] ')'
  static boolean impspec1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "impspec1")) return false;
    if (!nextTokenIs(b, LPAREN)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, LPAREN);
    p = r; // pin = 1
    r = r && report_error_(b, impspec1_1(b, l + 1));
    r = p && consumeToken(b, RPAREN) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // [<<sequence [importt]>>]
  private static boolean impspec1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "impspec1_1")) return false;
    sequence(b, l + 1, impspec1_1_0_0_parser_);
    return true;
  }

  // [importt]
  private static boolean impspec1_1_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "impspec1_1_0_0")) return false;
    importt(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // LCASETOK altslist
  static boolean lambdacase(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "lambdacase")) return false;
    if (!nextTokenIs(b, LCASETOK)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, LCASETOK);
    p = r; // pin = 1
    r = r && altslist(b, l + 1);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  ...
  /* ********************************************************** */
  // '\' (apat | thaexp)+ "->" exp
  static boolean lambdapat(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "lambdapat")) return false;
    if (!nextTokenIs(b, BACKSLASH)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, BACKSLASH);
    r = r && lambdapat_1(b, l + 1);
    p = r; // pin = 2
  ...
  // (apat | thaexp)+
  private static boolean lambdapat_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "lambdapat_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = lambdapat_1_0(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!lambdapat_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "lambdapat_1", c)) break;
    }
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // apat | thaexp
  private static boolean lambdapat_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "lambdapat_1_0")) return false;
    boolean r;
    r = apat(b, l + 1);
    if (!r) r = thaexp(b, l + 1);
    return r;
  ...
  public static boolean letexp(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, LETEXP, null);
    r = consumeToken(b, LET);
    p = r; // pin = 1
    r = r && report_error_(b, decls(b, l + 1));
    r = p && letexp_2(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  static boolean lexp(PsiBuilder b, int l) {
    ...
    boolean r;
    r = lambdacase(b, l + 1);
    if (!r) r = lambdapat(b, l + 1);
    if (!r) r = letexp(b, l + 1);
    if (!r) r = ifexpr(b, l + 1);
    if (!r) r = caseof(b, l + 1);
    if (!r) r = doblock(b, l + 1);
    if (!r) r = mdoblock(b, l + 1);
    if (!r) r = procarrow(b, l + 1);
    if (!r) r = aexps(b, l + 1);
    return r;
  }
  ...
  /* ********************************************************** */
  // "mdo" stmts
  static boolean mdoblock(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "mdoblock")) return false;
    if (!nextTokenIs(b, MDOTOK)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
  ...
  public static boolean moduledecl(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, MODULEDECL, null);
    r = consumeToken(b, MODULETOKEN);
    p = r; // pin = 1
  ...
  public static boolean newconstr(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<newconstr>", CONIDREGEXP, LPAREN)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, NEWCONSTR, "<newconstr>");
    r = con(b, l + 1);
    p = r; // pin = 1
  ...
  public static boolean newtypedecl(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, NEWTYPEDECL, null);
    r = consumeToken(b, NEWTYPE);
    p = r; // pin = 1
  ...
  public static boolean oqtycon(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<oqtycon>", CONIDREGEXP, LPAREN)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, OQTYCON, "<oqtycon>");
    r = oqtycon_0(b, l + 1);
    if (!r) r = qtycon(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  public static boolean ppragma(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, PPRAGMA, null);
    r = consumeToken(b, OPENPRAGMA);
    p = r; // pin = 1
    r = r && report_error_(b, ppragma_1(b, l + 1));
    r = p && consumeToken(b, CLOSEPRAGMA) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  /* ********************************************************** */
  // "proc" (aexp "->" exp | aexp*)
  static boolean procarrow(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "procarrow")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, "proc");
    p = r; // pin = 1
    r = r && procarrow_1(b, l + 1);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // aexp "->" exp | aexp*
  private static boolean procarrow_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "procarrow_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = procarrow_1_0(b, l + 1);
    if (!r) r = procarrow_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // aexp "->" exp
  private static boolean procarrow_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "procarrow_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = aexp(b, l + 1);
    r = r && consumeToken(b, RIGHTARROW);
  ...
  // aexp*
  private static boolean procarrow_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "procarrow_1_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!aexp(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "procarrow_1_1", c)) break;
    }
    return true;
  }
  ...
  public static boolean qcon(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<qcon>", CONIDREGEXP, LPAREN)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, QCON, "<qcon>");
    r = qconid(b, l + 1);
    if (!r) r = qcon_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  public static boolean qconop(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, QCONOP, "<qconop>");
    r = gconsym(b, l + 1);
  ...
  public static boolean qconsym(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<qconsym>", CONIDREGEXP, CONSYMTOK)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, QCONSYM, "<qconsym>");
    r = qconsym_0(b, l + 1);
    r = r && consym(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  public static boolean qop(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, QOP, "<qop>");
    r = qvarop(b, l + 1);
    if (!r) r = qconop(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  public static boolean qtyconop(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, QTYCONOP, "<qtyconop>");
    r = qtyconsym(b, l + 1);
  ...
  public static boolean qtyconsym(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, QTYCONSYM, "<qtyconsym>");
    r = qconsym(b, l + 1);
  ...
  public static boolean qvar(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, QVAR, "<qvar>");
    r = qvarid(b, l + 1);
    if (!r) r = qvar_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  public static boolean qvarid(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, QVARID, "<qvarid>");
    r = qvarid_0(b, l + 1);
    r = r && varid(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  public static boolean qvarop(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, QVAROP, "<qvarop>");
    r = qvarsym(b, l + 1);
  ...
  public static boolean qvars(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, QVARS, "<qvars>");
  ...
  /* ********************************************************** */
  // <<p>> (',' <<p>>)*
  static boolean sequence(PsiBuilder b, int l, Parser _p) {
  ...
  // (',' <<p>>)*
  private static boolean sequence_1(PsiBuilder b, int l, Parser _p) {
  ...
  // ',' <<p>>
  private static boolean sequence_1_0(PsiBuilder b, int l, Parser _p) {
  ...
  /* ********************************************************** */
  // open (partialstmt semi)* (letexp | partialstmt | exp) close
  public static boolean stmts(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "stmts")) return false;
    if (!nextTokenIs(b, "<stmts>", LBRACE, WHITESPACELBRACETOK)) return false;
    boolean r;
  ...
  private static boolean stmts_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "stmts_2")) return false;
    boolean r;
    r = letexp(b, l + 1);
  ...
  public static boolean tv_bndr(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, TV_BNDR, "<tv bndr>");
    r = tv_bndr_0(b, l + 1);
    if (!r) r = tyvar(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  public static boolean tyconsym(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, TYCONSYM, "<tyconsym>");
    r = consym(b, l + 1);
    if (!r) r = varsym(b, l + 1);
    if (!r) r = consumeToken(b, ASTERISK);
    if (!r) r = consumeToken(b, MINUS);
  ...
  public static boolean typedecl(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, TYPEDECL, null);
    r = consumeToken(b, TYPE);
    p = r; // pin = 1
  ...
  public static boolean tyvar(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, TYVAR, "<tyvar>");
    r = varid(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean varid(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, VARID, "<varid>");
  ...
  public static boolean varop(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, VAROP, "<varop>");
    r = varsym(b, l + 1);
  ...
  public static boolean varsym(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, VARSYM, "<varsym>");
  ...
  static final Parser impspec1_1_0_0_parser_ = new Parser() {
    public boolean parse(PsiBuilder b, int l) {
      return impspec1_1_0_0(b, l + 1);
    }
  };
  ...
  static final Parser toplevel_recover_parser_ = new Parser() {
    public boolean parse(PsiBuilder b, int l) {
      return toplevel_recover(b, l + 1);
    }
  };
