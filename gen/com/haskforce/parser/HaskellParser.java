...
public class HaskellParser implements PsiParser {
  ...
  private static boolean export_2_1_0(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = export_2_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean importt_1_1_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = importt_1_1_0_0(builder_, level_ + 1);
    if (!result_) result_ = importt_1_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // '(' ".." ')'
  private static boolean importt_1_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "importt_1_1_0_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, LPAREN);
